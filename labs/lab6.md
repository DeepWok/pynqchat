...
If you have completed the labs and are looking for more challenges, here are some optional extensions you can try out that may help you to get a higher score for the mid-term lab oral:
...
6. Full integration with the database: Why don't you try to integrate the database with your Pyqn Chatbot? Have you considered logging down all user queries and LLM replies in the DB and what is your end-to-end latency like?
